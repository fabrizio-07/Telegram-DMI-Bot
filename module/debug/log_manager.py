...
def error_handler(
    ...
    min_traceback_list = [
        line for line in traceback_list if "module" in line and "venv" not in line
    ]
    ...
    try:  # log the error
        ...
        ):  # if the update contains a message, show additional info
...
def notify_error_admin(context: CallbackContext, traceback_str: str):
    ...
    context.bot.send_message(
        chat_id=config_map['dev_group_chatid_logs'],
        text=text,
