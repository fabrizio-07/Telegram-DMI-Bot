...
def help_cmd(update: Update, context: CallbackContext, edit: bool = False) -> None:
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.HELP_DIPARTIMENTO_CDL_KEYBOARD_TEXT_ID),
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.HELP_APPUNTI_CLOUD_KEYBOARD_TEXT_ID),
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.HELP_SEGRETERIA_CONTATTI_KEYBOARD_TEXT_ID),
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.HELP_ERSU_ORARI_KEYBOARD_TEXT_ID),
                callback_data="sm_help_ersu",
            )
        ]
    )
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(
                    locale, TEXT_IDS.HELP_REGOLAMENTO_DIDATTICO_KEYBOARD_TEXT_ID
                ),
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(
                    locale, TEXT_IDS.HELP_PROGETTI_RICONOSCIMENTI_KEYBOARD_TEXT_ID
                ),
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.MERCATINO_LIBRI_KEYBOARD_TEXT_ID),
                callback_data="md_mercatino",
            )
        ]
    )
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.HELP_FAQ_TOOLTIP_ID), callback_data="md_faq"
            )
        ]
    )
    keyboard.append(
...
def help_dip_cdl(
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.HELP_CDL_EXAMS_TEXT_ID),
                callback_data="localization_HELP_CDL_EXAMS_LINK_TOOLTIP_ID",
            ),
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.AULARIO_KEYBOARD_TEXT_ID),
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.HELP_CDL_LESSONS_TIMETABLE_TEXT_ID),
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.HELP_CDL_REPRS_TEXT_ID),
                callback_data="sm_help_rapp_menu",
            ),
        ]
    )
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.HELP_CDL_LIBRARY_TEXT_ID),
                callback_data="localization_HELP_CDL_LIBRARY_TOOLTIP_ID",
            ),
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.HELP_CDL_GROUPS_TEXT_ID),
                callback_data="md_gruppi",
            ),
        ]
    )
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.HELP_CDL_PROF_INFO_TEXT_ID),
                callback_data="localization_HELP_CDL_PROF_TOOLTIP_ID",
            ),
            InlineKeyboardButton(
...
def help_rapp_menu(
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.REPRS_DMI_TEXT_ID),
                callback_data="localization_REPRS_DMI_TOOLTIP_ID",
            ),
        ]
    )
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.REPRS_DMI_CS_TEXT_ID),
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.REPRS_DMI_MATH_TEXT_ID),
...
def help_segr(
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.SEGR_DID_TEXT_ID),
                callback_data="localization_SEGR_DID_TOOLTIP_ID",
            ),
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.SEGR_STU_TEXT_ID),
                callback_data="localization_SEGR_STU_TOOLTIP_ID",
            ),
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.SEGR_CEA_TEXT_ID),
                callback_data="localization_SEGR_CEA_TOOLTIP_ID",
            ),
        ]
    )
    keyboard.append(
...
def help_ersu(
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.ERSU_TEXT_ID),
                callback_data="localization_ERSU_TOOLTIP_ID",
            ),
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.ERSU_OFFICE_TEXT_ID),
                callback_data="localization_ERSU_OFFICE_TOOLTIP_ID",
            ),
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.ERSU_URP_TEXT_ID),
                callback_data="localization_ERSU_URP_TOOLTIP_ID",
            ),
        ]
    )
    keyboard.append(
...
def help_projects_acknowledgements(
    update: Update, context: CallbackContext, chat_id: int, message_id: int
) -> None:
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.PRJ_OPIS_TEXT_ID),
                callback_data="md_opismanager",
            ),
            InlineKeyboardButton(
                get_locale(locale, TEXT_IDS.CREDITS_CONTRIBUTORS_TEXT_ID),
